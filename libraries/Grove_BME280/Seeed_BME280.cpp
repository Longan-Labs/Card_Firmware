...
uint8_t BME280::BME280Read8(uint8_t reg)
{
  ...
  Wire1.requestFrom(BME280_ADDRESS, 1);
...
uint16_t BME280::BME280Read16(uint8_t reg)
{
  ...
  Wire1.requestFrom(BME280_ADDRESS, 2);
...
uint32_t BME280::BME280Read24(uint8_t reg)
{
  ...
  Wire1.requestFrom(BME280_ADDRESS, 3);
...
{
  Wire1.beginTransmission(BME280_ADDRESS); // start transmission to device
  Wire1.write(reg);       // send register address
