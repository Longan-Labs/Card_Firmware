...
// speed, -100~100
void motor_4wd::speed1(int speed)
{
...
// speed, -100~100
void motor_4wd::speed2(int speed)
{
    if(speed > 100 || speed < -100)return;
